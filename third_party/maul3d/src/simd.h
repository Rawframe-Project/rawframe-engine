...
#ifndef MAUL3D_SRC_SIMD_H
#define MAUL3D_SRC_SIMD_H
...
#if defined(M3_SIMD_AVX2)

#include <immintrin.h>

typedef __m256 m3f8;

static inline m3f8 m3F8Load(const float* p)
{
    return _mm256_loadu_ps(p);
}
static inline void m3F8Store(float* p, m3f8 v)
{
    _mm256_storeu_ps(p, v);
}
static inline m3f8 m3F8Set1(float x)
{
    return _mm256_set1_ps(x);
}
static inline m3f8 m3F8Zero(void)
{
    return _mm256_setzero_ps();
}
static inline m3f8 m3F8Add(m3f8 a, m3f8 b)
{
    return _mm256_add_ps(a, b);
}
static inline m3f8 m3F8Sub(m3f8 a, m3f8 b)
{
    return _mm256_sub_ps(a, b);
}
static inline m3f8 m3F8Mul(m3f8 a, m3f8 b)
{
    return _mm256_mul_ps(a, b);
}
static inline m3f8 m3F8Neg(m3f8 a)
{
    return _mm256_xor_ps(a, _mm256_set1_ps(-0.0f));
}
// a * b + c, one rounding.
static inline m3f8 m3F8MulAdd(m3f8 a, m3f8 b, m3f8 c)
{
    return _mm256_fmadd_ps(a, b, c);
}
// c - a * b, one rounding.
static inline m3f8 m3F8NegMulAdd(m3f8 a, m3f8 b, m3f8 c)
{
    return _mm256_fnmadd_ps(a, b, c);
}
// mask lanes are all-ones or all-zeros; mask ? a : b.
static inline m3f8 m3F8Select(m3f8 mask, m3f8 a, m3f8 b)
{
    return _mm256_blendv_ps(b, a, mask);
}
static inline m3f8 m3F8GT(m3f8 a, m3f8 b)
{
    return _mm256_cmp_ps(a, b, _CMP_GT_OQ);
}
static inline m3f8 m3F8LT(m3f8 a, m3f8 b)
{
    return _mm256_cmp_ps(a, b, _CMP_LT_OQ);
}
static inline m3f8 m3F8EQ(m3f8 a, m3f8 b)
{
    return _mm256_cmp_ps(a, b, _CMP_EQ_OQ);
}
static inline m3f8 m3F8Div(m3f8 a, m3f8 b)
{
    return _mm256_div_ps(a, b);
}
static inline m3f8 m3F8Sqrt(m3f8 a)
{
    return _mm256_sqrt_ps(a);
}
static inline m3f8 m3F8And(m3f8 a, m3f8 b)
{
...
static inline m3f8 m3F8Load(const float* p)
{
    m3f8 r = {vld1q_f32(p), vld1q_f32(p + 4)};
    return r;
}
static inline void m3F8Store(float* p, m3f8 v)
{
...
static inline m3f8 m3F8Set1(float x)
{
    m3f8 r = {vdupq_n_f32(x), vdupq_n_f32(x)};
    return r;
}
static inline m3f8 m3F8Zero(void)
{
    return m3F8Set1(0.0f);
}
static inline m3f8 m3F8Add(m3f8 a, m3f8 b)
{
    m3f8 r = {vaddq_f32(a.lo, b.lo), vaddq_f32(a.hi, b.hi)};
    return r;
}
static inline m3f8 m3F8Sub(m3f8 a, m3f8 b)
{
    m3f8 r = {vsubq_f32(a.lo, b.lo), vsubq_f32(a.hi, b.hi)};
    return r;
}
static inline m3f8 m3F8Mul(m3f8 a, m3f8 b)
{
    m3f8 r = {vmulq_f32(a.lo, b.lo), vmulq_f32(a.hi, b.hi)};
    return r;
}
static inline m3f8 m3F8Neg(m3f8 a)
{
    m3f8 r = {vnegq_f32(a.lo), vnegq_f32(a.hi)};
    return r;
}
static inline m3f8 m3F8MulAdd(m3f8 a, m3f8 b, m3f8 c)
{
    // vfmaq(c, a, b) = c + a * b, one rounding.
    m3f8 r = {vfmaq_f32(c.lo, a.lo, b.lo), vfmaq_f32(c.hi, a.hi, b.hi)};
    return r;
}
static inline m3f8 m3F8NegMulAdd(m3f8 a, m3f8 b, m3f8 c)
{
    // vfmsq(c, a, b) = c - a * b, one rounding.
    m3f8 r = {vfmsq_f32(c.lo, a.lo, b.lo), vfmsq_f32(c.hi, a.hi, b.hi)};
    return r;
}
static inline m3f8 m3F8Select(m3f8 mask, m3f8 a, m3f8 b)
{
    m3f8 r = {vbslq_f32(vreinterpretq_u32_f32(mask.lo), a.lo, b.lo),
              vbslq_f32(vreinterpretq_u32_f32(mask.hi), a.hi, b.hi)};
    return r;
}
static inline m3f8 m3F8GT(m3f8 a, m3f8 b)
{
    m3f8 r = {vreinterpretq_f32_u32(vcgtq_f32(a.lo, b.lo)),
              vreinterpretq_f32_u32(vcgtq_f32(a.hi, b.hi))};
    return r;
}
static inline m3f8 m3F8LT(m3f8 a, m3f8 b)
{
    m3f8 r = {vreinterpretq_f32_u32(vcltq_f32(a.lo, b.lo)),
              vreinterpretq_f32_u32(vcltq_f32(a.hi, b.hi))};
    return r;
}
static inline m3f8 m3F8EQ(m3f8 a, m3f8 b)
{
    m3f8 r = {vreinterpretq_f32_u32(vceqq_f32(a.lo, b.lo)),
              vreinterpretq_f32_u32(vceqq_f32(a.hi, b.hi))};
    return r;
}
static inline m3f8 m3F8Div(m3f8 a, m3f8 b)
{
    m3f8 r = {vdivq_f32(a.lo, b.lo), vdivq_f32(a.hi, b.hi)};
    return r;
}
static inline m3f8 m3F8Sqrt(m3f8 a)
{
    m3f8 r = {vsqrtq_f32(a.lo), vsqrtq_f32(a.hi)};
    return r;
}
static inline m3f8 m3F8And(m3f8 a, m3f8 b)
{
...
static inline m3f8 m3F8Cmp(int kind, m3f8 a, m3f8 b)
{
    m3f8 r;
    for (int32_t i = 0; i < 8; ++i)
    {
...
static inline m3f8 m3F8GT(m3f8 a, m3f8 b)
{
    return m3F8Cmp(1, a, b);
}
static inline m3f8 m3F8LT(m3f8 a, m3f8 b)
{
    return m3F8Cmp(0, a, b);
}
static inline m3f8 m3F8EQ(m3f8 a, m3f8 b)
{
    return m3F8Cmp(2, a, b);
}
static inline m3f8 m3F8Div(m3f8 a, m3f8 b)
{
    m3f8 r;
...
static inline m3f8 m3F8Max(m3f8 a, m3f8 b)
{
    return m3F8Select(m3F8GT(a, b), a, b);
}
static inline m3f8 m3F8Min(m3f8 a, m3f8 b)
{
    return m3F8Select(m3F8LT(a, b), a, b);
}

#endif // MAUL3D_SRC_SIMD_H
